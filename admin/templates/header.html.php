...
<script>
    var pms="<?php echo isset($_GET['menu'])?$_GET['menu']:'_'?>";
</script>
...
<div id="main">
    <div id="left" style="height: 100%">
        <ul>
            ...
            <?php foreach($_SESSION[DOMAIN]['pms'] as $key=>$row):?>
                <li>
    ...
    <div id="right" style="height: 100%">
        <div class="m_title">
            <div class="m_local f_l"><a href="?">首页</a><?php echo isset($_GET['menu'])? '&gt;<a>'.$_SESSION[DOMAIN]['pms'][$_GET['menu']]['name'].'</a>':''?>
            <?php echo isset($_GET['sub'])? '&gt;<a>'.$_SESSION[DOMAIN]['pms'][$_GET['menu']]['sub'][$_GET['sub']]['name'].'</a>' : ''?>
               </div>
